...
class SentimentAnalyser:
    def __init__(self, stock_symbol: str):
        self.stock_symbol = stock_symbol
        try:
            self.tokenizer = AutoTokenizer.from_pretrained("yiyanghkust/finbert-tone", local_files_only=False)
            self.model = AutoModelForSequenceClassification.from_pretrained("yiyanghkust/finbert-tone", local_files_only=False, force_download=True)
            self.model.eval()
        except Exception as e:
